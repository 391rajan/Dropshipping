          ...
          <div className="lg:col-span-2 lg:row-span-2 lg:row-end-2">
            ...
            <div className="mt-10 flex flex-col items-center justify-between space-y-4 border-t border-b py-4 sm:flex-row sm:space-y-0">
              <div className="flex items-end">
                ...
                {item.onSale === "yes" ? (
                  <h1 className="text-3xl font-bold text-red-700 ml-5">{`${(
                    item.price -
              ...
              <button
                ...
                className="mt-1.5 flex w-full items-center justify-center rounded-md bg-black px-5 py-3 text-xs font-medium uppercase tracking-wide text-white"
              >
